...
const EditSingleChoiceModal = ({ tabsFunction, singleData, editAddEmptyOption, editdeleteOption, editOptionValue, editQuestionText, editQuestions, editErrors, title,loading }) => {
    return (
        <>
            <div className='modal_wrapper' onClick={(() => tabsFunction(0))}></div>
            <div className='modal_div'>
                <h4>{title} Single Choice</h4>
                ...
                <div style={{ margin: "20px 0" }}>
                    ...
                    {title == 'Edit' && <div className="options_wrapper466885">
                        <h3>Options</h3>
                        <Button
